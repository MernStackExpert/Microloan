      ...
      <div className="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
        <div className="w-full md:w-auto">
          ...
          <p className="text-base-content/60">
            Monitor and manage all loan requests.
          </p>
        </div>
            ...
            >
              <div className="flex justify-between items-start mb-3">
                <div className="flex items-center gap-2">
                  <div className="bg-neutral/10 p-2 rounded-full text-neutral">
                    <FaUser />
                  </div>
                  <div>
          ...
          {selectedApp && (
            <div className="space-y-4 text-sm md:text-base">
                ...
                <div className="bg-base-200 p-4 rounded-xl">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="flex justify-between">
                      <span>Email:</span>{" "}
                      <span
                        className="font-medium truncate w-32 text-right"
                    ...
                    <p className="flex justify-between">
                      <span>Income:</span>{" "}
                      <span className="font-medium">
                        ৳{selectedApp.monthlyIncome} ({selectedApp.incomeSource}
                        )
                      </span>
                    </p>
                  </div>
              ...
              <div className="bg-base-200 p-4 rounded-xl">
                ...
                <p className="mb-2">
                  <span className="opacity-70 font-semibold">Address:</span>{" "}
                  {selectedApp.address}
                </p>
                <p>
                  ...
                  <span className="italic">"{selectedApp.reason}"</span>
                </p>
              </div>
            </div>
          )}
