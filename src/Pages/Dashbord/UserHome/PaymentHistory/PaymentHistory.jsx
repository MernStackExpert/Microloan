...
import { FaHistory, FaCalendarAlt, FaCreditCard, FaSearch } from 'react-icons/fa';
            ...
            <div className="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-base-content/60">Track all your application fee payments.</p>
                    </div>
                </div>
                            ...
                            filteredPayments.map((payment, index) => (
                                <tr key={payment._id}>
                                    ...
                                    <td>
                                        ...
                                        <div className="text-xs badge badge-ghost badge-sm">{payment.category}</div>
                                    </td>
