        ...
        <div>
          <Link to="/" className="flex items-center gap-3 group mb-2">
            ...
            <div className="hidden sm:block">
              ...
              <p className="text-xs text-base-content/60 -mt-1 tracking-widest">
                MICRO FINANCE
              </p>
            </div>
          </Link>
          <p className="text-base-content/70">
            Fast and reliable loan services to help you grow. Trusted by
            thousands of borrowers nationwide.
          </p>
